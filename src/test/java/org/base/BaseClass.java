...
System.out.println(text);
	...
	public static void screenshot(String filename) throws IOException {
		...
		File dest=new File("C:\\Users\\User\\eclipse-workspace2\\Cucumber2\\Screenshot"+filename+".png");
...
public static String excelRead(int row,int cell) throws IOException {
		...
		File f=new File("C:\\Users\\User\\eclipse-workspace2\\Cucumber2\\testdata\\cucumber amazon.xlsx");
